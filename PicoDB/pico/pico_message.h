...
namespace pico {
    ...
    public:
        ...
        static pico_message convertBuffersToMessage(
                                                    pico_buffered_message<pico_record> all_buffers
            ...
            while (!all_buffers.msg_in_buffers->empty()) {
                ...
                if (pico_record::recordStartsWithBEGKEY(buf)) {
                    ...
                    std::cout << "the value part of key record as string is "
                    << tempWithoutKeyPart << std::endl;
                    ...
                    //is not in db
                {
                    ...
                    if (!temp.empty()) {
                        ...
                        std::cout << "the buffer is empty so we ignore it " << temp
                        << std::endl;
