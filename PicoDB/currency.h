...
public:
	...
	Currency() {//default constructor
        mylogger.log( "default constructor called" );
        name = "defaultName";
        price = "defaultPrice";
    ...
    {
        mylogger.log("move constructor called" );
        name = other.name;
        price = other.price;
        symbol = other.symbol;
        ts = other.ts;
...
//	void serialize(boost::archive::text_iarchive &ar,const unsigned int version);
    ...
    Currency(const Currency& other) {
        mylogger.log("copy constructor called" );
        name = other.name;
        price = other.price;
        symbol = other.symbol;
        ts = other.ts;
    ...
    Currency& operator=(const Currency& other) {
        mylogger.log("copy assignment called" );
        name = other.name;
        price = other.price;
        symbol = other.symbol;
        ts = other.ts;
    ...
    ~Currency() {
        mylogger.log( "destructor for currency called");
    }
    std::string toString() const {
